                    ...
                    <div class="col-lg-8 col-sm-10">
                        <div class="text-center mt-lg-5 pt-5">
                            ...
                            <div class="d-flex gap-2 justify-content-center mt-4">
                                <a href="{{ route('register') }}" class="btn btn-primary">Get Started <i class="ri-arrow-right-line align-middle ms-1"></i></a>
            ...
            <div class="container">
                <div class="row align-items-center gy-4">
                    <div class="col-lg-6 col-sm-7 mx-auto">
                        <div>
                            <img src="{{ asset('assets/images/landing/features/img-1.png') }}" alt="Feature Image 1" class="img-fluid mx-auto">
                        </div>
                    </div>
                    <div class="col-lg-6">
            ...
            <div class="container">
                <div class="row align-items-center gy-4">
                    ...
                    <div class="col-lg-6 col-sm-7 col-10 ms-auto order-1 order-lg-2">
                        <div>
                            <img src="{{ asset('assets/images/landing/features/img-2.png') }}" alt="Feature Image 2" class="img-fluid">
                        </div>
                    </div>
                </div>
                <!-- end row -->
                ...
                <div class="row align-items-center mt-5 pt-lg-5 gy-4">
                    <div class="col-lg-6 col-sm-7 col-10 mx-auto">
                        <div>
                            <img src="{{ asset('assets/images/landing/features/img-3.png') }}" alt="Feature Image 3" class="img-fluid">
                        </div>
                    </div>
                    <div class="col-lg-6">
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="row justify-content-center">
                                            <div class="col-10">
                                                <div class="text-white-50">
                                                    <p class="fs-20 ff-secondary mb-4">" Amazing template, Redux store and components is nicely designed. It's a great start point for an admin based project. Clean Code and good documentation. Template is completely in React and absolutely
                                                        no usage of jQuery "</p>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="card-body text-center p-4">
                                <div class="avatar-xl mx-auto mb-4 position-relative">
                                    <img src="{{ asset('assets/images/users/avatar-9.jpg') }}" alt="" class="img-fluid rounded-circle">
                                    <a href="apps-mailbox.html" class="btn btn-success btn-sm position-absolute bottom-0 end-0 rounded-circle avatar-xs">
                                        <div class="avatar-title bg-transparent">
                                            <i class="ri-mail-fill align-bottom"></i>
                                        </div>
                                ...
                                <!-- end card body -->
                                <h5 class="mb-1"><a href="pages-profile.html" class="text-body">Jane Doe</a></h5>
                                <p class="text-muted mb-0 ff-secondary">Graphic Designer</p>
                            </div>
                        </div>
                        <!-- end card -->
                    </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="card-body text-center p-4">
                                ...
                                <!-- end card body -->
                                <h5 class="mb-1"><a href="pages-profile.html" class="text-body">Peter Wilson</a></h5>
                                <p class="text-muted mb-0 ff-secondary">Marketing Strategist</p>
                            </div>
                        </div>
                        <!-- end card -->
                    </div>
